package com.martiandeveloper.a20style_a_foreground_notification
...
class MyService : Service() {
    ...
    private fun displayForegroundNotification() {
        ...
        val notification =
            NotificationCompat.Builder(this, channelId).setContentTitle("Playing music")
                .setContentText(AUDIO_FILE).setSmallIcon(R.drawable.ic_alarm)
                .setContentIntent(pendingIntent).addAction(0, "Play", playIntent)
                .addAction(0, "Stop", stopIntent).setPriority(NotificationCompat.PRIORITY_HIGH)
                .setWhen(0)
                .setStyle(
